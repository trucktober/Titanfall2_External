...
namespace ImGui
{
    ...
    IMGUI_API void          StyleColorsCosmicLatteConfetti(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsNeonNostalgiaNightmare(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsRetroRainbowRuckus(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsSoothingSeafoamSerenity(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsWildZazzy(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsZeroTwo(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsGojo(ImGuiStyle* dst = NULL);
    // Windows
