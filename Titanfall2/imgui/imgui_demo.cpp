...
bool ImGui::ShowStyleSelector(const char* label)
{
    ...
    if (ImGui::Combo(label, &style_idx, "Dark\0Light\0Classic\0Retro\0Pink Nightmare\0Rainbow\0Seafoam\0Zazzy\0Zero Two\0Gojo\0"))
    {
        switch (style_idx)
        {
        ...
        case 3: ImGui::StyleColorsCosmicLatteConfetti(); break;
        case 4: ImGui::StyleColorsNeonNostalgiaNightmare(); break;
        case 5: ImGui::StyleColorsRetroRainbowRuckus(); break;
        case 6: ImGui::StyleColorsSoothingSeafoamSerenity(); break;
        case 7: ImGui::StyleColorsWildZazzy(); break;
        case 8: ImGui::StyleColorsZeroTwo(); break;
        case 9: ImGui::StyleColorsGojo(); break;      
        }
        return true;
    }
    return false;
